...
public final class CommandIndex extends HelpIndex {
	
	public CommandIndex() {
		super("Commands");
	}
	
	protected void addAssitance(HelpIndex assistance) {
		super.addSection(assistance);
	}
	
	@Override
	public void addSection(HelpSection section) {}
	
	protected void removeAssistance(HelpIndex assistance) {
		super.removeSection(assistance);
	}
