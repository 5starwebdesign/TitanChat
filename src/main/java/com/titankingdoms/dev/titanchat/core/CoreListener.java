...
public final class CoreListener implements Listener {
	...
	public void onAsyncPlayerChat(AsyncPlayerChatEvent event) {
		...
		Point recipient = sender.getCurrentPoint();
		String format = (recipient != null) ? recipient.getFormat() : "%prefix%display%suffix: %message";
		...
		plugin.converse(sender, recipient, format, message);
	}
